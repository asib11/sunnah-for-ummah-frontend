...
import { Loader2, ShoppingCart, ChevronRight, Star, Truck, RotateCcw } from "lucide-react";
...
export default function ProductDetailsClient({ handle }: { handle: string }) {
  ...
  const { data: product, isLoading, isError } = useQuery({
    ...
    queryFn: ({ signal }) => storeApi.getProductByHandle(handle, { signal }),
    enabled: !!handle,
  });
