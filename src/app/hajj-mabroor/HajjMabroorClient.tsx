...
// import HajjKitDetails, { HAJJ_KIT_HANDLE, HAJJ_KIT_QUERY_KEY } from "@/components/HajjKitDetails"; // temporarily hidden
...
const HajjMabroor = () => {
  ...
  // Live kit stats — hidden while kit section is not shown
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8 md:py-12 space-y-8">
        ...
        {/* What's Inside the Kit section — temporarily hidden
        <section
          id="whats-inside-kit"
