...
import _product1 from "@/assets/product-1.webp";
const product1 = _product1.src;
import _product2 from "@/assets/product-2.webp";
const product2 = _product2.src;
import _product3 from "@/assets/product-3.webp";
const product3 = _product3.src;
import _product4 from "@/assets/product-4.webp";
const product4 = _product4.src;
import _product5 from "@/assets/product-5.webp";
const product5 = _product5.src;
import _product6 from "@/assets/product-6.webp";
const product6 = _product6.src;
import _product7 from "@/assets/product-7.webp";
const product7 = _product7.src;
import _product8 from "@/assets/product-8.webp";
const product8 = _product8.src;

import _dropFront from "@/assets/calligraphy-drop-shoulder-front.webp";
const dropFront = _dropFront.src;
import _dropBack from "@/assets/calligraphy-drop-shoulder-back.webp";
const dropBack = _dropBack.src;
import _dropTee from "@/assets/calligraphy-drop-shoulder-tshirt.webp";
const dropTee = _dropTee.src;
import _dropTeeBack from "@/assets/calligraphy-drop-shoulder-studio-back.webp";
const dropTeeBack = _dropTeeBack.src;
import _muslimPair from "@/assets/muslim-tee-pair.webp";
const muslimPair = _muslimPair.src;
import _muslimFB from "@/assets/muslim-tshirt-front-back.webp";
const muslimFB = _muslimFB.src;
import _sabrFB from "@/assets/sabr-tshirt-front-back.webp";
const sabrFB = _sabrFB.src;
import _tawakkul from "@/assets/tawakkul-tshirt.webp";
const tawakkul = _tawakkul.src;
import _tawakkulBack from "@/assets/tawakkul-tshirt-back.webp";
const tawakkulBack = _tawakkulBack.src;
import _timesFront from "@/assets/times-of-success-tshirt.webp";
const timesFront = _timesFront.src;
import _timesBack from "@/assets/times-of-success-tshirt-back.webp";
const timesBack = _timesBack.src;

import _baggyBlack from "@/assets/baggy-sweatpants-black.webp";
const baggyBlack = _baggyBlack.src;
import _baggyWashed from "@/assets/baggy-sweatpants-washed.webp";
const baggyWashed = _baggyWashed.src;
import _baggyWhite from "@/assets/baggy-sweatpants-white.webp";
const baggyWhite = _baggyWhite.src;
import _baggyBack from "@/assets/baggy-sweatpants-back.webp";
